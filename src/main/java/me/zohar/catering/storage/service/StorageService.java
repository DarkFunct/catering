package me.zohar.catering.storage.service;
...
import me.zohar.catering.storage.repo.StorageRepo;
import me.zohar.catering.storage.vo.StorageVO;
...
public class StorageService {
	...
	public String uploadGatheringCode(InputStream inputStream, Long fileSize, String fileType, String fileName) {
		if (!fileType.startsWith("image/")) {
			throw new BizException(BizError.只能上传图片类型的附件);
		}
